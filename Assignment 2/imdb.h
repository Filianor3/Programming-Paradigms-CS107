...
class imdb {
 ...
 private:
  ...
  void getMoviesForActor(vector<film> & films, char* actorInfo, const string& player) const;
  film getFilm(int offset) const;
  void getActorsForMovie(vector<string> &players, char* movieInfo) const;
  void getActorsForMovie(vector<string>& players, char* movieInfoStart, const film& movie) const;
  string getActor(int offset) const;
