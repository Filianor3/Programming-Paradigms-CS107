...
typedef struct {
    ...
    int allocLength;
    int initLen;
    VectorFreeFunction cleanerFunc;
    VectorCompareFunction comparFunc;
    VectorMapFunction mapFunc;
} vector;
 ...
 * to specify that the vector is already in sorted order, in which case Vector Search
